import{j as e}from"./jsx-runtime-DoxjgJx5.js";import{r as c}from"./index-Cu9bd8lq.js";import{N as d,a as n}from"./NavItem-DbwpsiHc.js";import"./index-C2KoGaFq.js";const y={title:"Nav",component:d,tags:["autodocs"],parameters:{controls:{include:["aria-label"]},design:{type:"figma",url:"https://www.figma.com/file/rTaQE2nIUSLav4Tg3nozq7/Compound-Web-Components?type=design&node-id=669-2723&mode=design&t=9Hy0h7BBDH0kJ2Ow-0"}},args:{"aria-label":"Main"}},i={args:{children:e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>{},children:"Info"}),e.jsx(n,{onClick:()=>{},active:!0,children:"People"}),e.jsx(n,{onClick:()=>{},disabled:!0,children:"Disabled"}),e.jsx(n,{href:"https://example.com",children:"External"})]})}},l={render:function(){const[a,t]=c.useState("panel-2"),r=(s,p)=>{const o=document.querySelector(`#${s}`);o&&(o.style.display=p)};return c.useEffect(()=>{["panel-1","panel-2"].forEach(s=>{r(s,"none")}),r(a,"block")},[a]),e.jsxs("div",{children:[e.jsxs(d,{role:"tablist","aria-label":"main",children:[e.jsx(n,{"aria-controls":"panel-1",onClick:()=>{t("panel-1")},active:a==="panel-1",children:"Tab 1"}),e.jsx(n,{"aria-controls":"panel-2",onClick:()=>{t("panel-2")},active:a==="panel-2",children:"Tab 2"}),e.jsx(n,{"aria-controls":"panel-3",onClick:()=>{},disabled:!0,children:"Disabled Tab"})]}),e.jsx("div",{id:"panel-1",style:{display:"none"},children:"This is panel 1"}),e.jsx("div",{id:"panel-2",style:{display:"none"},children:"This is panel 2"}),e.jsx("div",{id:"panel-3",style:{display:"none"},children:"This is panel 3"})]})}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    children: <>
...
}`,...l.parameters?.docs?.source}}};const b=["Default","TabRole"];export{i as Default,l as TabRole,b as __namedExportsOrder,y as default};
