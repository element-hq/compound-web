...
`,jr=k`
  ...
  bottom: 0;
  left: 0;
`,Vr=({onZoomIn:o,onZoomOut:e,onReset:t})=>p(_,null,p(le,{onClick:o},p(fo,null)),p(le,{onClick:e},p(mo,null)),p(le,{onClick:t},p(go,null))),zr=(o,e)=>{let[t,r]=M(1);T(()=>{r(o)},e);let i=P(()=>{r(c=>c+.1)},[r]),n=P(()=>{r(c=>Math.max(c-.1,.1))},[r]),s=P(()=>{r(1)},[r]);return{scale:t,zoomIn:i,zoomOut:n,resetZoom:s}},Yr=({config:o})=>{let e=zr(o.scale||1,[o.scale]),t=G(()=>({transform:`scale(${e.scale})`}),[e.scale]);return p("div",{css:Gr},p(dt,{border:!0},p("div",{style:{display:"grid",gridAutoFlow:"column",gap:"4px",alignItems:"center"}},p(_,{key:"left"},p("p",null,p("b",null,"Image")),p(ht,null),p(Vr,{onReset:e.resetZoom,onZoomIn:e.zoomIn,onZoomOut:e.zoomOut})))),p(Ur,{css:Wr,defaultValue:o.offset},p("img",{css:Zr,src:o.url,style:t})))},Gr=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,qr=({config:o})=>p("div",{css:Xr},p(K,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),Xr=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  align-items: center;
`;lt();var Kr=o=>{if(o.protocol!=="https:")return{valid:!1,error:p(_,null,"Expected HTTPS link, received ",p("code",null,o.protocol),".")};if(o.hostname!=="www.sketch.com")return{valid:!1,error:p(_,null,"Expected a hostname ",p("code",null,"www.sketch.com"),", received"," ",p("code",null,o.hostname))};let e=p(_,null,"Expected pathname ",p("code",null,"/s/<string>/a/<string>"),", received"," ",p("code",null,o.pathname),"."),t=o.pathname.split("/").slice(1);if(t.length<4)return{valid:!1,error:e};if(t[0]==="embed")return{valid:!0,data:{url:o.href,offscreen:!1}};let[r,i,n,s]=t;return r!=="s"||!i||n!=="a"||!s?{valid:!1,error:e}:{valid:!0,data:{url:`https://www.sketch.com/embed/s/${i}/a/${s}`,offscreen:!1}}},Jr=({config:o})=>{let e=G(()=>{let t=Kr(new URL(o.url));return t.valid?{...t,data:{...o,...t.data}}:t},[o]);return e.valid?p(Ie,{defer:!0,config:e.data}):p(H,null,p(_,null,"Invalid Sketch URL"),p(_,null,e.error))},Qr=({tabs:o,deps:e=[]})=>{let[t,r]=M(o[0].id);return T(()=>{r(o[0].id)},e),p(pt,{absolute:!0,selected:t,actions:{onSelect:r}},o.map(i=>p("div",{key:i.id,id:i.id,title:i.name},i.offscreen||t===i.id?i.content:null)))},ei=Ce(()=>Promise.resolve().then(()=>(Nr(),$o))),ti=({config:o})=>{if(!o||"length"in o&&o.length===0)return p(H,null,p(_,null,"No designs found"),p(_,null,"Learn how to"," ",p(K,{href:"https://github.com/storybookjs/addon-designs#3-add-it-to-story",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"display design preview for the story")));let e=[...o instanceof Array?o:[o]].map(t=>{let r={id:JSON.stringify(t),name:t.name||t.type?.toUpperCase()||"ERROR",offscreen:t.offscreen??!0};switch(t.type){case"iframe":return{...r,content:p(Ie,{config:t})};case"figma":return{...r,content:p(wo,{config:t}),offscreen:!1};case"sketch":return{...r,content:p(Jr,{config:t})};case"figspec":case"experimental-figspec":return t.type==="experimental-figspec"&&console.warn("[storybook-addon-designs] `experimental-figspec` is deprecated. We will remove it in v7.0. Please replace it to `figspec` type."),{...r,content:p(Ee,{fallback:"Preparing Figspec viewer..."},p(ei,{config:t})),offscreen:!1};case"image":return{...r,content:p(Yr,{config:t})};case"link":return{...r,content:p(qr,{config:t})}}return{...r,content:p(H,null,p(_,null,"Invalid config type"),p(_,null,"Config type you set is not supported. Please choose one from"," ",p(K,{href:"https://github.com/storybookjs/addon-designs/blob/master/packages/storybook-addon-designs/src/config.ts",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"available config types")))}});return e.length===1?p("div",null,e[0].content):p(Qr,{tabs:e,deps:[o]})},oi=({active:o})=>{let e=uo(),t=ot(st),[r,i]=M(o);return T(()=>{i(o)},[t]),T(()=>{o&&i(!0)},[o]),r?p(ti,{key:e.storyId,config:t}):null},$e="Design";function ri(o){tt.register(Ao,e=>{let t=function(){let r=ot(st);return r?Array.isArray(r)?r.length>0?`${$e} (${r.length})`:$e:(r.name||$e)+" (1)":$e};tt.add(Lr,{type:po.PANEL,title:t,paramKey:st,render({active:r}){return p(ct,{active:!!r},p(Hr,null,p(oi,{active:!!r})))}})})}ri();})();
