try{
(()=>{var Eo=Object.defineProperty;var Co=(o,e)=>{for(var t in e)Eo(o,t,{get:e[t],enumerable:!0})};var m={NODE_ENV:"production",NODE_PATH:[],STORYBOOK:"true",PUBLIC_URL:"."};var ae={};Co(ae,{Children:()=>ko,Component:()=>Ae,Fragment:()=>_,Profiler:()=>To,PureComponent:()=>Ro,StrictMode:()=>Bo,Suspense:()=>Ee,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>Oo,act:()=>No,cloneElement:()=>Lo,createContext:()=>Ho,createElement:()=>Do,createFactory:()=>Fo,createRef:()=>Uo,default:()=>Mo,forwardRef:()=>Vo,isValidElement:()=>jo,lazy:()=>Ce,memo:()=>zo,startTransition:()=>Yo,unstable_act:()=>Go,useCallback:()=>P,useContext:()=>Wo,useDebugValue:()=>Zo,useDeferredValue:()=>qo,useEffect:()=>T,useId:()=>Xo,useImperativeHandle:()=>Ko,useInsertionEffect:()=>Jo,useLayoutEffect:()=>Qo,useMemo:()=>G,useReducer:()=>er,useRef:()=>tr,useState:()=>M,useSyncExternalStore:()=>or,useTransition:()=>rr,version:()=>ir});var Mo=__REACT__,{Children:ko,Component:Ae,Fragment:_,Profiler:To,PureComponent:Ro,StrictMode:Bo,Suspense:Ee,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Oo,act:No,cloneElement:Lo,createContext:Ho,createElement:Do,createFactory:Fo,createRef:Uo,forwardRef:Vo,isValidElement:jo,lazy:Ce,memo:zo,startTransition:Yo,unstable_act:Go,useCallback:P,useContext:Wo,useDebugValue:Zo,useDeferredValue:qo,useEffect:T,useId:Xo,useImperativeHandle:Ko,useInsertionEffect:Jo,useLayoutEffect:Qo,useMemo:G,useReducer:er,useRef:tr,useState:M,useSyncExternalStore:or,useTransition:rr,version:ir}=__REACT__;var pi=__STORYBOOK_THEMING__,{CacheProvider:ui,ClassNames:fi,Global:mi,ThemeProvider:gi,background:vi,color:yi,convert:bi,create:xi,createCache:wi,createGlobal:_i,createReset:$i,css:k,darken:Ii,ensure:Si,ignoreSsrWarning:Ai,isPropValid:Ei,jsx:p,keyframes:Ci,lighten:Pi,styled:Mi,themes:ki,typography:Ti,useTheme:Ri,withTheme:Bi}=__STORYBOOK_THEMING__;var Di=__STORYBOOK_COMPONENTS__,{A:Fi,ActionBar:Ui,AddonPanel:ct,Badge:Vi,Bar:ji,Blockquote:zi,Button:Yi,ClipboardCode:Gi,Code:Wi,DL:Zi,Div:qi,DocumentWrapper:Xi,EmptyTabContent:Ki,ErrorFormatter:Ji,FlexBar:dt,Form:Qi,H1:en,H2:tn,H3:on,H4:rn,H5:nn,H6:sn,HR:an,IconButton:le,Img:ln,LI:cn,Link:K,ListItem:dn,Loader:hn,Modal:pn,OL:un,P:fn,Placeholder:H,Pre:mn,ProgressSpinner:gn,ResetWrapper:vn,ScrollArea:yn,Separator:ht,Spaced:bn,Span:xn,StorybookIcon:wn,StorybookLogo:_n,SyntaxHighlighter:$n,TT:In,TabBar:Sn,TabButton:An,TabWrapper:En,Table:Cn,Tabs:pt,TabsState:Pn,TooltipLinkList:Mn,TooltipMessage:kn,TooltipNote:Tn,UL:Rn,WithTooltip:Bn,WithTooltipPure:On,Zoom:Nn,codeCommon:Ln,components:Hn,createCopyToClipboardFunction:Dn,getStoryHref:Fn,interleaveSeparators:Un,nameSpaceClassNames:Vn,resetComponents:jn,withReset:zn}=__STORYBOOK_COMPONENTS__;var ce=window,de=ce.ShadowRoot&&(ce.ShadyCSS===void 0||ce.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Pe=Symbol(),ut=new WeakMap,J=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==Pe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(de&&e===void 0){let r=t!==void 0&&t.length===1;r&&(e=ut.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&ut.set(t,e))}return e}toString(){return this.cssText}},ft=o=>new J(typeof o=="string"?o:o+"",void 0,Pe),A=(o,...e)=>{let t=o.length===1?o[0]:e.reduce((r,i,n)=>r+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+o[n+1],o[0]);return new J(t,o,Pe)},Me=(o,e)=>{de?o.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{let r=document.createElement("style"),i=ce.litNonce;i!==void 0&&r.setAttribute("nonce",i),r.textContent=t.cssText,o.appendChild(r)})},he=de?o=>o:o=>o instanceof CSSStyleSheet?(e=>{let t="";for(let r of e.cssRules)t+=r.cssText;return ft(t)})(o):o;var ke,pe=window,mt=pe.trustedTypes,nr=mt?mt.emptyScript:"",gt=pe.reactiveElementPolyfillSupport,Re={toAttribute(o,e){switch(e){case Boolean:o=o?nr:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,e){let t=o;switch(e){case Boolean:t=o!==null;break;case Number:t=o===null?null:Number(o);break;case Object:case Array:try{t=JSON.parse(o)}catch{t=null}}return t}},vt=(o,e)=>e!==o&&(e==e||o==o),Te={attribute:!0,type:String,converter:Re,reflect:!1,hasChanged:vt},Be="finalized",O=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();let e=[];return this.elementProperties.forEach((t,r)=>{let i=this._$Ep(r,t);i!==void 0&&(this._$Ev.set(i,r),e.push(i))}),e}static createProperty(e,t=Te){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){let r=typeof e=="symbol"?Symbol():"__"+e,i=this.getPropertyDescriptor(e,r,t);i!==void 0&&Object.defineProperty(this.prototype,e,i)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(i){let n=this[e];this[t]=i,this.requestUpdate(e,n,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Te}static finalize(){if(this.hasOwnProperty(Be))return!1;this[Be]=!0;let e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){let t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(let i of r)this.createProperty(i,t[i])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let r=new Set(e.flat(1/0).reverse());for(let i of r)t.unshift(he(i))}else e!==void 0&&t.push(he(e));return t}static _$Ep(e,t){let r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,r;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;let t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Me(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)})}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$EO(e,t,r=Te){var i;let n=this.constructor._$Ep(e,r);if(n!==void 0&&r.reflect===!0){let s=(((i=r.converter)===null||i===void 0?void 0:i.toAttribute)!==void 0?r.converter:Re).toAttribute(t,r.type);this._$El=e,s==null?this.removeAttribute(n):this.setAttribute(n,s),this._$El=null}}_$AK(e,t){var r;let i=this.constructor,n=i._$Ev.get(e);if(n!==void 0&&this._$El!==n){let s=i.getPropertyOptions(n),c=typeof s.converter=="function"?{fromAttribute:s.converter}:((r=s.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?s.converter:Re;this._$El=n,this[n]=c.fromAttribute(t,s.type),this._$El=null}}requestUpdate(e,t,r){let i=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||vt)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,r))):i=!1),!this.isUpdatePending&&i&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((i,n)=>this[n]=i),this._$Ei=void 0);let t=!1,r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$ES)===null||e===void 0||e.forEach(i=>{var n;return(n=i.hostUpdate)===null||n===void 0?void 0:n.call(i)}),this.update(r)):this._$Ek()}catch(i){throw t=!1,this._$Ek(),i}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(r=>{var i;return(i=r.hostUpdated)===null||i===void 0?void 0:i.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,r)=>this._$EO(r,this[r],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};O[Be]=!0,O.elementProperties=new Map,O.elementStyles=[],O.shadowRootOptions={mode:"open"},gt?.({ReactiveElement:O}),((ke=pe.reactiveElementVersions)!==null&&ke!==void 0?ke:pe.reactiveElementVersions=[]).push("1.6.3");var Oe,ue=window,W=ue.trustedTypes,yt=W?W.createPolicy("lit-html",{createHTML:o=>o}):void 0,Le="$lit$",D=`lit$${(Math.random()+"").slice(9)}$`,St="?"+D,sr=`<${St}>`,z=document,ee=()=>z.createComment(""),te=o=>o===null||typeof o!="object"&&typeof o!="function",At=Array.isArray,ar=o=>At(o)||typeof o?.[Symbol.iterator]=="function",Ne=`[ 	
\f\r]`,Q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,bt=/-->/g,xt=/>/g,V=RegExp(`>|${Ne}(?:([^\\s"'>=/]+)(${Ne}*=${Ne}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),wt=/'/g,_t=/"/g,Et=/^(?:script|style|textarea|title)$/i,Ct=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),b=Ct(1),E=Ct(2),N=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),$t=new WeakMap,j=z.createTreeWalker(z,129,null,!1);function Pt(o,e){if(!Array.isArray(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return yt!==void 0?yt.createHTML(e):e}var lr=(o,e)=>{let t=o.length-1,r=[],i,n=e===2?"<svg>":"",s=Q;for(let c=0;c<t;c++){let a=o[c],d,l,h=-1,u=0;for(;u<a.length&&(s.lastIndex=u,l=s.exec(a),l!==null);)u=s.lastIndex,s===Q?l[1]==="!--"?s=bt:l[1]!==void 0?s=xt:l[2]!==void 0?(Et.test(l[2])&&(i=RegExp("</"+l[2],"g")),s=V):l[3]!==void 0&&(s=V):s===V?l[0]===">"?(s=i??Q,h=-1):l[1]===void 0?h=-2:(h=s.lastIndex-l[2].length,d=l[1],s=l[3]===void 0?V:l[3]==='"'?_t:wt):s===_t||s===wt?s=V:s===bt||s===xt?s=Q:(s=V,i=void 0);let f=s===V&&o[c+1].startsWith("/>")?" ":"";n+=s===Q?a+sr:h>=0?(r.push(d),a.slice(0,h)+Le+a.slice(h)+D+f):a+D+(h===-2?(r.push(void 0),c):f)}return[Pt(o,n+(o[t]||"<?>")+(e===2?"</svg>":"")),r]},oe=class o{constructor({strings:e,_$litType$:t},r){let i;this.parts=[];let n=0,s=0,c=e.length-1,a=this.parts,[d,l]=lr(e,t);if(this.el=o.createElement(d,r),j.currentNode=this.el.content,t===2){let h=this.el.content,u=h.firstChild;u.remove(),h.append(...u.childNodes)}for(;(i=j.nextNode())!==null&&a.length<c;){if(i.nodeType===1){if(i.hasAttributes()){let h=[];for(let u of i.getAttributeNames())if(u.endsWith(Le)||u.startsWith(D)){let f=l[s++];if(h.push(u),f!==void 0){let g=i.getAttribute(f.toLowerCase()+Le).split(D),x=/([.?@])?(.*)/.exec(f);a.push({type:1,index:n,name:x[2],strings:g,ctor:x[1]==="."?De:x[1]==="?"?Fe:x[1]==="@"?Ue:q})}else a.push({type:6,index:n})}for(let u of h)i.removeAttribute(u)}if(Et.test(i.tagName)){let h=i.textContent.split(D),u=h.length-1;if(u>0){i.textContent=W?W.emptyScript:"";for(let f=0;f<u;f++)i.append(h[f],ee()),j.nextNode(),a.push({type:2,index:++n});i.append(h[u],ee())}}}else if(i.nodeType===8)if(i.data===St)a.push({type:2,index:n});else{let h=-1;for(;(h=i.data.indexOf(D,h+1))!==-1;)a.push({type:7,index:n}),h+=D.length-1}n++}}static createElement(e,t){let r=z.createElement("template");return r.innerHTML=e,r}};function Z(o,e,t=o,r){var i,n,s,c;if(e===N)return e;let a=r!==void 0?(i=t._$Co)===null||i===void 0?void 0:i[r]:t._$Cl,d=te(e)?void 0:e._$litDirective$;return a?.constructor!==d&&((n=a?._$AO)===null||n===void 0||n.call(a,!1),d===void 0?a=void 0:(a=new d(o),a._$AT(o,t,r)),r!==void 0?((s=(c=t)._$Co)!==null&&s!==void 0?s:c._$Co=[])[r]=a:t._$Cl=a),a!==void 0&&(e=Z(o,a._$AS(o,e.values),a,r)),e}var He=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;let{el:{content:r},parts:i}=this._$AD,n=((t=e?.creationScope)!==null&&t!==void 0?t:z).importNode(r,!0);j.currentNode=n;let s=j.nextNode(),c=0,a=0,d=i[0];for(;d!==void 0;){if(c===d.index){let l;d.type===2?l=new re(s,s.nextSibling,this,e):d.type===1?l=new d.ctor(s,d.name,d.strings,this,e):d.type===6&&(l=new Ve(s,this,e)),this._$AV.push(l),d=i[++a]}c!==d?.index&&(s=j.nextNode(),c++)}return j.currentNode=z,n}v(e){let t=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},re=class o{constructor(e,t,r,i){var n;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=i,this._$Cp=(n=i?.isConnected)===null||n===void 0||n}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Z(this,e,t),te(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==N&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):ar(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==$&&te(this._$AH)?this._$AA.nextSibling.data=e:this.$(z.createTextNode(e)),this._$AH=e}g(e){var t;let{values:r,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=oe.createElement(Pt(i.h,i.h[0]),this.options)),i);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===n)this._$AH.v(r);else{let s=new He(n,this),c=s.u(this.options);s.v(r),this.$(c),this._$AH=s}}_$AC(e){let t=$t.get(e.strings);return t===void 0&&$t.set(e.strings,t=new oe(e)),t}T(e){At(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,r,i=0;for(let n of e)i===t.length?t.push(r=new o(this.k(ee()),this.k(ee()),this,this.options)):r=t[i],r._$AI(n),i++;i<t.length&&(this._$AR(r&&r._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){let i=e.nextSibling;e.remove(),e=i}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},q=class{constructor(e,t,r,i,n){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,i){let n=this.strings,s=!1;if(n===void 0)e=Z(this,e,t,0),s=!te(e)||e!==this._$AH&&e!==N,s&&(this._$AH=e);else{let c=e,a,d;for(e=n[0],a=0;a<n.length-1;a++)d=Z(this,c[r+a],t,a),d===N&&(d=this._$AH[a]),s||(s=!te(d)||d!==this._$AH[a]),d===$?e=$:e!==$&&(e+=(d??"")+n[a+1]),this._$AH[a]=d}s&&!i&&this.j(e)}j(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},De=class extends q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$?void 0:e}},cr=W?W.emptyScript:"",Fe=class extends q{constructor(){super(...arguments),this.type=4}j(e){e&&e!==$?this.element.setAttribute(this.name,cr):this.element.removeAttribute(this.name)}},Ue=class extends q{constructor(e,t,r,i,n){super(e,t,r,i,n),this.type=5}_$AI(e,t=this){var r;if((e=(r=Z(this,e,t,0))!==null&&r!==void 0?r:$)===N)return;let i=this._$AH,n=e===$&&i!==$||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==$&&(i===$||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}},Ve=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Z(this,e)}};var It=ue.litHtmlPolyfillSupport;It?.(oe,re),((Oe=ue.litHtmlVersions)!==null&&Oe!==void 0?Oe:ue.litHtmlVersions=[]).push("2.8.0");var Mt=(o,e,t)=>{var r,i;let n=(r=t?.renderBefore)!==null&&r!==void 0?r:e,s=n._$litPart$;if(s===void 0){let c=(i=t?.renderBefore)!==null&&i!==void 0?i:null;n._$litPart$=s=new re(e.insertBefore(ee(),c),c,void 0,t??{})}return s._$AI(o),s};var je,ze;var R=class extends O{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;let r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Mt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return N}};R.finalized=!0,R._$litElement$=!0,(je=globalThis.litElementHydrateSupport)===null||je===void 0||je.call(globalThis,{LitElement:R});var kt=globalThis.litElementPolyfillSupport;kt?.({LitElement:R});((ze=globalThis.litElementVersions)!==null&&ze!==void 0?ze:globalThis.litElementVersions=[]).push("3.3.3");var dr=(o,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,o)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,o)}},hr=(o,e,t)=>{e.constructor.createProperty(t,o)};function I(o){return(e,t)=>t!==void 0?hr(o,e,t):dr(o,e)}var Ye,ua=((Ye=window.HTMLSlotElement)===null||Ye===void 0?void 0:Ye.prototype.assignedElements)!=null?(o,e)=>o.assignedElements(e):(o,e)=>o.assignedNodes(e).filter(t=>t.nodeType===Node.ELEMENT_NODE);var L=({title:o,children:e})=>b`
...
`;var Rt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Bt=o=>(...e)=>({_$litDirective$:o,values:e}),fe=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var Ot="important",pr=" !"+Ot,Y=Bt(class extends fe{constructor(o){var e;if(super(o),o.type!==Rt.ATTRIBUTE||o.name!=="style"||((e=o.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{let r=o[t];return r==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(o,[e]){let{style:t}=o.element;if(this.ht===void 0){this.ht=new Set;for(let r in e)this.ht.add(r);return this.render(e)}this.ht.forEach(r=>{e[r]==null&&(this.ht.delete(r),r.includes("-")?t.removeProperty(r):t[r]="")});for(let r in e){let i=e[r];if(i!=null){this.ht.add(r);let n=typeof i=="string"&&i.endsWith(pr);r.includes("-")||n?t.setProperty(r,n?i.slice(0,-11):i,n?Ot:""):t[r]=i}}return N}});function Nt(o){return{top:o.y,right:o.x+o.width,bottom:o.y+o.height,left:o.x}}function Ht(o,e){let t=Nt(o),r=Nt(e),i=!(t.top>r.bottom||t.bottom<r.top),n=!(t.left>r.right||t.right<r.left);if(n&&i){let l={x:(Math.max(t.left,r.left)+Math.min(t.right,r.right))/2,y:(Math.max(t.top,r.top)+Math.min(t.bottom,r.bottom))/2};return[{points:[{x:t.left,y:l.y},{x:r.left,y:l.y}]},{points:[{x:t.right,y:l.y},{x:r.right,y:l.y}]},{points:[{y:t.top,x:l.x},{y:r.top,x:l.x}]},{points:[{y:t.bottom,x:l.x},{y:r.bottom,x:l.x}]}]}let s=t.left>r.right,c=t.top>r.bottom,a={x:o.x+o.width/2,y:o.y+o.height/2};return[n?null:{points:[{x:s?t.left:t.right,y:a.y},{x:s?r.right:r.left,y:a.y}],bisector:i?void 0:[{x:s?r.right:r.left,y:a.y},{x:s?r.right:r.left,y:c?r.bottom:r.top}]},i?null:{points:[{y:c?t.top:t.bottom,x:a.x},{y:c?r.bottom:r.top,x:a.x}],bisector:n?void 0:[{y:c?r.bottom:r.top,x:a.x},{y:c?r.bottom:r.top,x:s?r.right:r.left}]}].filter(l=>!!l)}function ne(o){return Math.round(o*100)/100}function me(o,e){return[...Lt(o),...Lt(e)]}function Lt(o){return o?o instanceof Array?o:[o]:[]}var ur=function(o,e,t,r){var i=arguments.length,n=i<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var c=o.length-1;c>=0;c--)(s=o[c])&&(n=(i<3?s(n):i>3?s(e,t,n):s(e,t))||n);return i>3&&n&&Object.defineProperty(e,t,n),n},Dt=o=>{class e extends o{constructor(...r){super(...r),this.selectedNode=null}updated(r){super.updated(r),r.has("selectedNode")&&this.dispatchEvent(new CustomEvent("nodeselect",{detail:{selectedNode:this.selectedNode}}))}}return ur([I({attribute:!1})],e.prototype,"selectedNode",void 0),e};function ge(o){return o.touches.length===0||o.touches.length>2}function fr(o,e){return Math.sqrt(Math.pow(o.x-e.x,2)+Math.pow(o.y-e.y,2))}var Ft=o=>class extends o{constructor(...t){super(...t),this.previousTouches=null,this.addEventListener("touchstart",r=>{ge(r)||(r.preventDefault(),this.previousTouches=r.touches)}),this.addEventListener("touchend",r=>{ge(r)||(r.preventDefault(),this.previousTouches=null)}),this.addEventListener("touchcancel",r=>{ge(r)||(r.preventDefault(),this.previousTouches=null)}),this.addEventListener("touchmove",r=>{if(ge(r))return;let i=Array.from(this.previousTouches||[]),n=Array.from(r.touches);if(this.previousTouches=r.touches,!(n.length!==i.length||!n.every(s=>i.some(c=>c.identifier===s.identifier)))){if(n.length===1){this.onTouchPan({x:n[0].pageX-i[0].pageX,y:n[0].pageY-i[0].pageY});return}this.onTouchPinch(fr({x:n[0].pageX,y:n[0].pageY},{x:i[0].pageX,y:i[0].pageY}))}})}get isTouching(){return!!(this.previousTouches&&this.previousTouches.length>0)}onTouchPan(t){}onTouchPinch(t){}};var se=function(o,e,t,r){var i=arguments.length,n=i<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var c=o.length-1;c>=0;c--)(s=o[c])&&(n=(i<3?s(n):i>3?s(e,t,n):s(e,t))||n);return i>3&&n&&Object.defineProperty(e,t,n),n},B=function(o,e,t,r){if(t==="a"&&!r)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?o!==e||!r:!e.has(o))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?r:t==="a"?r.call(o):r?r.value:e.get(o)},Ut=function(o,e,t,r,i){if(r==="m")throw new TypeError("Private method is not writable");if(r==="a"&&!i)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?o!==e||!i:!e.has(o))throw new TypeError("Cannot write private member to an object whose class did not declare it");return r==="a"?i.call(o,t):i?i.value=t:e.set(o,t),t},Vt=o=>{var e,t,r,i,n;class s extends Ft(o){constructor(...a){super(...a),this.panX=0,this.panY=0,this.scale=1,this.zoomSpeed=500,this.panSpeed=500,e.set(this,!1),t.set(this,(l,h)=>{this.panX+=l/this.scale/window.devicePixelRatio,this.panY+=h/this.scale/window.devicePixelRatio}),r.set(this,l=>{l.code==="Space"&&!B(this,e,"f")&&(Ut(this,e,!0,"f"),document.body.style.cursor="grab")}),i.set(this,l=>{l.code==="Space"&&B(this,e,"f")&&(Ut(this,e,!1,"f"),document.body.style.cursor="auto")}),n.set(this,()=>{document.addEventListener("keyup",B(this,i,"f")),document.addEventListener("keydown",B(this,r,"f"))}),this.addEventListener("wheel",l=>{if(this.isMovable)if(l.preventDefault(),l.ctrlKey){let{deltaY:h}=l;l.deltaMode===1&&(h*=15);let u=this.scale;this.scale*=1-h/((1e3-this.zoomSpeed)*.5);let f=l.offsetX-this.offsetWidth/2,g=l.offsetY-this.offsetHeight/2;this.panX+=f/this.scale-f/u,this.panY+=g/this.scale-g/u}else{let h=this.panSpeed*.002;this.panX-=l.deltaX*h/this.scale,this.panY-=l.deltaY*h/this.scale}},{passive:!1});let d=1;this.addEventListener("gesturestart",l=>{l.preventDefault(),d=this.scale}),this.addEventListener("gesturechange",l=>{let h=l;h.preventDefault(),this.scale=d*h.scale}),this.addEventListener("pointermove",l=>{l.buttons&4&&(l.preventDefault(),B(this,t,"f").call(this,l.movementX,l.movementY))}),B(this,n,"f").call(this),this.onmousedown=()=>{B(this,e,"f")&&(document.body.style.cursor="grabbing",this.onmousemove=({movementX:l,movementY:h})=>{B(this,t,"f").call(this,l,h)},this.onmouseup=()=>{document.body.style.cursor="grab",this.onmousemove=null,this.onmouseup=null})}}get isMovable(){return!0}get canvasTransform(){return[`scale(${this.scale})`,`translate(${this.panX}px, ${this.panY}px)`]}disconnectedCallback(){document.removeEventListener("keyup",B(this,i,"f")),document.removeEventListener("keydown",B(this,r,"f")),super.disconnectedCallback()}updated(a){super.updated(a),a.has("scale")&&this.dispatchEvent(new CustomEvent("scalechange",{detail:{scale:this.scale}})),(a.has("panX")||a.has("panY"))&&this.dispatchEvent(new CustomEvent("positionchange",{detail:{x:this.panX,y:this.panY}}))}onTouchPan(a){this.panX+=a.x/this.scale,this.panY+=a.y/this.scale}onTouchPinch(a){this.scale*=1-a/1e3}}return e=new WeakMap,t=new WeakMap,r=new WeakMap,i=new WeakMap,n=new WeakMap,se([I({attribute:!1})],s.prototype,"panX",void 0),se([I({attribute:!1})],s.prototype,"panY",void 0),se([I({attribute:!1})],s.prototype,"scale",void 0),se([I({type:Number,attribute:"zoom-speed"})],s.prototype,"zoomSpeed",void 0),se([I({type:Number,attribute:"pan-speed"})],s.prototype,"panSpeed",void 0),s};var mr=({guide:o,reverseScale:e})=>{let t=Math.abs(o.points[0].x-o.points[1].x),r=Math.abs(o.points[0].y-o.points[1].y);return t===0&&r===0?null:E`
  ...
  `},jt=new Map,zt=({node:o,distanceTo:e,reverseScale:t,fontSize:r})=>{let i=o.id+`
`+e.id,n=jt.get(i);return n||(n=Ht(o.absoluteBoundingBox,e.absoluteBoundingBox),jt.set(i,n)),[...n.map(s=>mr({guide:s,reverseScale:t})),...n.map(s=>gr({guide:s,reverseScale:t,fontSize:r}))]},Yt=A`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`,io=o=>{if(!o||!o.link||o.link===void 0||o.link==="undefined")return null;let{link:e,timestamp:t,fileName:r}=o;return b`<a
  ...
  >
    ...
    `}getMetadata(){return{fileName:this.documentNode.name,timestamp:this.documentNode.lastModified,link:this.link}}connectedCallback(){super.connectedCallback(),this.documentNode&&(Qe(this,xe,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom()))}updated(e){super.updated(e),e.has("documentNode")&&(Qe(this,xe,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom())),e.has("renderedImages")&&this.__updateEffectMargins()}};xe=new WeakMap,et=new WeakMap;ao([I({type:Object,attribute:"document-node"})],U.prototype,"documentNode",void 0);ao([I({type:Object,attribute:"rendered-images"})],U.prototype,"renderedImages",void 0);customElements.get("figspec-file-viewer")||customElements.define("figspec-file-viewer",U);customElements.get("figspec-frame-viewer")||customElements.define("figspec-frame-viewer",F);var Pr=new Set(["children","localName","ref","style","className"]),lo=new WeakMap,Mr=(o,e,t,r,i)=>{let n=i?.[e];n===void 0||t===r?t==null&&e in HTMLElement.prototype?o.removeAttribute(e):o[e]=t:((s,c,a)=>{let d=lo.get(s);d===void 0&&lo.set(s,d=new Map);let l=d.get(c);a!==void 0?l===void 0?(d.set(c,l={handleEvent:a}),s.addEventListener(c,l)):l.handleEvent=a:l!==void 0&&(d.delete(c),s.removeEventListener(c,l))})(o,n,t)},kr=(o,e)=>{typeof o=="function"?o(e):o.current=e};function we(o=window.React,e,t,r,i){let n,s,c;if(e===void 0){let f=o;({tagName:s,elementClass:c,events:r,displayName:i}=f),n=f.react}else n=o,c=t,s=e;let a=n.Component,d=n.createElement,l=new Set(Object.keys(r??{}));class h extends a{constructor(){super(...arguments),this.o=null}t(g){if(this.o!==null)for(let x in this.i)Mr(this.o,x,this.props[x],g?g[x]:void 0,r)}componentDidMount(){var g;this.t(),(g=this.o)===null||g===void 0||g.removeAttribute("defer-hydration")}componentDidUpdate(g){this.t(g)}render(){let{_$Gl:g,...x}=this.props;this.h!==g&&(this.u=w=>{g!==null&&kr(g,w),this.o=w,this.h=g}),this.i={};let S={ref:this.u};for(let[w,Se]of Object.entries(x))Pr.has(w)?S[w==="className"?"class":w]=Se:l.has(w)||w in c.prototype?this.i[w]=Se:S[w]=Se;return S.suppressHydrationWarning=!0,d(s,S)}}h.displayName=i??c.name;let u=n.forwardRef((f,g)=>d(h,{...f,_$Gl:g},f?.children));return u.displayName=h.displayName,u}var co=we(ae,"figspec-frame-viewer",F,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"}),ho=we(ae,"figspec-file-viewer",U,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"});var Qc=__STORYBOOK_API__,{ActiveTabs:ed,Consumer:td,ManagerContext:od,Provider:rd,RequestResponseError:id,addons:tt,combineParameters:nd,controlOrMetaKey:sd,controlOrMetaSymbol:ad,eventMatchesShortcut:ld,eventToShortcut:cd,experimental_MockUniversalStore:dd,experimental_UniversalStore:hd,experimental_getStatusStore:pd,experimental_getTestProviderStore:ud,experimental_requestResponse:fd,experimental_useStatusStore:md,experimental_useTestProviderStore:gd,experimental_useUniversalStore:vd,internal_fullStatusStore:yd,internal_fullTestProviderStore:bd,internal_universalStatusStore:xd,internal_universalTestProviderStore:wd,isMacLike:_d,isShortcutTaken:$d,keyToSymbol:Id,merge:Sd,mockChannel:Ad,optionOrAltSymbol:Ed,shortcutMatchesShortcut:Cd,shortcutToHumanString:Pd,types:po,useAddonState:Md,useArgTypes:kd,useArgs:Td,useChannel:Rd,useGlobalTypes:Bd,useGlobals:Od,useParameter:ot,useSharedState:Nd,useStoryPrepared:Ld,useStorybookApi:Hd,useStorybookState:uo}=__STORYBOOK_API__;var jd=__STORYBOOK_ICONS__,{AccessibilityAltIcon:zd,AccessibilityIcon:Yd,AccessibilityIgnoredIcon:Gd,AddIcon:Wd,AdminIcon:Zd,AlertAltIcon:qd,AlertIcon:Xd,AlignLeftIcon:Kd,AlignRightIcon:Jd,AppleIcon:Qd,ArrowBottomLeftIcon:eh,ArrowBottomRightIcon:th,ArrowDownIcon:oh,ArrowLeftIcon:rh,ArrowRightIcon:ih,ArrowSolidDownIcon:nh,ArrowSolidLeftIcon:sh,ArrowSolidRightIcon:ah,ArrowSolidUpIcon:lh,ArrowTopLeftIcon:ch,ArrowTopRightIcon:dh,ArrowUpIcon:hh,AzureDevOpsIcon:ph,BackIcon:uh,BasketIcon:fh,BatchAcceptIcon:mh,BatchDenyIcon:gh,BeakerIcon:vh,BellIcon:yh,BitbucketIcon:bh,BoldIcon:xh,BookIcon:wh,BookmarkHollowIcon:_h,BookmarkIcon:$h,BottomBarIcon:Ih,BottomBarToggleIcon:Sh,BoxIcon:Ah,BranchIcon:Eh,BrowserIcon:Ch,ButtonIcon:Ph,CPUIcon:Mh,CalendarIcon:kh,CameraIcon:Th,CameraStabilizeIcon:Rh,CategoryIcon:Bh,CertificateIcon:Oh,ChangedIcon:Nh,ChatIcon:Lh,CheckIcon:Hh,ChevronDownIcon:Dh,ChevronLeftIcon:Fh,ChevronRightIcon:Uh,ChevronSmallDownIcon:Vh,ChevronSmallLeftIcon:jh,ChevronSmallRightIcon:zh,ChevronSmallUpIcon:Yh,ChevronUpIcon:Gh,ChromaticIcon:Wh,ChromeIcon:Zh,CircleHollowIcon:qh,CircleIcon:Xh,ClearIcon:Kh,CloseAltIcon:Jh,CloseIcon:Qh,CloudHollowIcon:ep,CloudIcon:tp,CogIcon:op,CollapseIcon:rp,CommandIcon:ip,CommentAddIcon:np,CommentIcon:sp,CommentsIcon:ap,CommitIcon:lp,CompassIcon:cp,ComponentDrivenIcon:dp,ComponentIcon:hp,ContrastIcon:pp,ContrastIgnoredIcon:up,ControlsIcon:fp,CopyIcon:mp,CreditIcon:gp,CrossIcon:vp,DashboardIcon:yp,DatabaseIcon:bp,DeleteIcon:xp,DiamondIcon:wp,DirectionIcon:_p,DiscordIcon:$p,DocChartIcon:Ip,DocListIcon:Sp,DocumentIcon:Ap,DownloadIcon:Ep,DragIcon:Cp,EditIcon:Pp,EllipsisIcon:Mp,EmailIcon:kp,ExpandAltIcon:Tp,ExpandIcon:Rp,EyeCloseIcon:Bp,EyeIcon:Op,FaceHappyIcon:Np,FaceNeutralIcon:Lp,FaceSadIcon:Hp,FacebookIcon:Dp,FailedIcon:Fp,FastForwardIcon:Up,FigmaIcon:Vp,FilterIcon:jp,FlagIcon:zp,FolderIcon:Yp,FormIcon:Gp,GDriveIcon:Wp,GithubIcon:Zp,GitlabIcon:qp,GlobeIcon:Xp,GoogleIcon:Kp,GraphBarIcon:Jp,GraphLineIcon:Qp,GraphqlIcon:eu,GridAltIcon:tu,GridIcon:ou,GrowIcon:ru,HeartHollowIcon:iu,HeartIcon:nu,HomeIcon:su,HourglassIcon:au,InfoIcon:lu,ItalicIcon:cu,JumpToIcon:du,KeyIcon:hu,LightningIcon:pu,LightningOffIcon:uu,LinkBrokenIcon:fu,LinkIcon:mu,LinkedinIcon:gu,LinuxIcon:vu,ListOrderedIcon:yu,ListUnorderedIcon:bu,LocationIcon:xu,LockIcon:wu,MarkdownIcon:_u,MarkupIcon:$u,MediumIcon:Iu,MemoryIcon:Su,MenuIcon:Au,MergeIcon:Eu,MirrorIcon:Cu,MobileIcon:Pu,MoonIcon:Mu,NutIcon:ku,OutboxIcon:Tu,OutlineIcon:Ru,PaintBrushIcon:Bu,PaperClipIcon:Ou,ParagraphIcon:Nu,PassedIcon:Lu,PhoneIcon:Hu,PhotoDragIcon:Du,PhotoIcon:Fu,PhotoStabilizeIcon:Uu,PinAltIcon:Vu,PinIcon:ju,PlayAllHollowIcon:zu,PlayBackIcon:Yu,PlayHollowIcon:Gu,PlayIcon:Wu,PlayNextIcon:Zu,PlusIcon:qu,PointerDefaultIcon:Xu,PointerHandIcon:Ku,PowerIcon:Ju,PrintIcon:Qu,ProceedIcon:ef,ProfileIcon:tf,PullRequestIcon:of,QuestionIcon:rf,RSSIcon:nf,RedirectIcon:sf,ReduxIcon:af,RefreshIcon:lf,ReplyIcon:cf,RepoIcon:df,RequestChangeIcon:hf,RewindIcon:pf,RulerIcon:uf,SaveIcon:ff,SearchIcon:mf,ShareAltIcon:gf,ShareIcon:vf,ShieldIcon:yf,SideBySideIcon:bf,SidebarAltIcon:xf,SidebarAltToggleIcon:wf,SidebarIcon:_f,SidebarToggleIcon:$f,SpeakerIcon:If,StackedIcon:Sf,StarHollowIcon:Af,StarIcon:Ef,StatusFailIcon:Cf,StatusIcon:Pf,StatusPassIcon:Mf,StatusWarnIcon:kf,StickerIcon:Tf,StopAltHollowIcon:Rf,StopAltIcon:Bf,StopIcon:Of,StorybookIcon:Nf,StructureIcon:Lf,SubtractIcon:Hf,SunIcon:Df,SupportIcon:Ff,SweepIcon:Uf,SwitchAltIcon:Vf,SyncIcon:jf,TabletIcon:zf,ThumbsUpIcon:Yf,TimeIcon:Gf,TimerIcon:Wf,TransferIcon:Zf,TrashIcon:qf,TwitterIcon:Xf,TypeIcon:Kf,UbuntuIcon:Jf,UndoIcon:Qf,UnfoldIcon:em,UnlockIcon:tm,UnpinIcon:om,UploadIcon:rm,UserAddIcon:im,UserAltIcon:nm,UserIcon:sm,UsersIcon:am,VSCodeIcon:lm,VerifiedIcon:cm,VideoIcon:dm,WandIcon:hm,WatchIcon:pm,WindowsIcon:um,WrenchIcon:fm,XIcon:mm,YoutubeIcon:gm,ZoomIcon:fo,ZoomOutIcon:mo,ZoomResetIcon:go,iconList:vm}=__STORYBOOK_ICONS__;var Tr=Object.defineProperty,at=(o,e)=>()=>(o&&(e=o(o=0)),e),Rr=(o,e)=>{for(var t in e)Tr(o,t,{get:e[t],enumerable:!0})},Ie,vo,yo,bo,lt=at(()=>{Ie=({config:o,defer:e=!1})=>{let[t,r]=M(e?void 0:o.url),[i,n]=M(!1);return T(()=>{if(!e)return;let s=requestAnimationFrame(()=>{r(o.url)});return()=>cancelAnimationFrame(s)},[e,o.url]),T(()=>{n(!1)},[t]),p("div",{css:vo},!i&&p(H,{css:yo},"Loading..."),p("iframe",{css:bo,src:t,allowFullScreen:o.allowFullscreen,onLoad:()=>n(!0)}))},vo=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Ur=k`
  ...
  bottom: 0;
  left: 0;
`,Vr=({onZoomIn:o,onZoomOut:e,onReset:t})=>p(_,null,p(le,{onClick:o},p(fo,null)),p(le,{onClick:e},p(mo,null)),p(le,{onClick:t},p(go,null))),jr=(o,e)=>{let[t,r]=M(1);T(()=>{r(o)},e);let i=P(()=>{r(c=>c+.1)},[r]),n=P(()=>{r(c=>Math.max(c-.1,.1))},[r]),s=P(()=>{r(1)},[r]);return{scale:t,zoomIn:i,zoomOut:n,resetZoom:s}},zr=({config:o})=>{let e=jr(o.scale||1,[o.scale]),t=G(()=>({transform:`scale(${e.scale})`}),[e.scale]);return p("div",{css:Yr},p(dt,{border:!0},p("div",{style:{display:"grid",gridAutoFlow:"column",gap:"4px",alignItems:"center"}},p(_,{key:"left"},p("p",null,p("b",null,"Image")),p(ht,null),p(Vr,{onReset:e.resetZoom,onZoomIn:e.zoomIn,onZoomOut:e.zoomOut})))),p(Dr,{css:Gr,defaultValue:o.offset},p("img",{css:Wr,src:o.url,style:t})))},Yr=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Zr=({config:o})=>p("div",{css:qr},p(K,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),qr=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
