...
`});var Ro,yt,Bo,No,Oo,bt=w(()=>{d();h();p();F();Ro=({onClick:o=()=>{}})=>M`
...
`)}},Lo=o=>[Math.trunc(255*o.r),Math.trunc(255*o.g),Math.trunc(255*o.b)],fi=o=>{let[e,t,r]=Lo(o);return"#"+((1<<24)+(e<<16)+(t<<8)+r).toString(16).slice(1)},wt=({property:o,value:e})=>`${o}: ${e};`});var mi,_t,Fo,gi,vi,Do,Uo=w(()=>{d();h();p();F();bt();Ho();mi=function(o,e,t,r){function i(n){return n instanceof t?n:new t(function(s){s(n)})}return new(t||(t=Promise))(function(n,s){function c(l){try{u(r.next(l))}catch(f){s(f)}}function a(l){try{u(r.throw(l))}catch(f){s(f)}}function u(l){l.done?n(l.value):i(l.value).then(c,a)}u((r=r.apply(o,e||[])).next())})},_t=o=>mi(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(o)}),Fo=({node:o,onClose:e})=>{if(!o)return null;let t=new Le(o),r=i=>i.stopPropagation();return $`
    <div
...
`,Fi=({config:o})=>m("div",{css:Di},m(se,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),Di=R`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
