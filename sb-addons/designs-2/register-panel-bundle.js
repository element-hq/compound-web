try{
(()=>{var br=Object.defineProperty;var w=(o,e)=>()=>(o&&(e=o(o=0)),e);var Ct=(o,e)=>{for(var t in e)br(o,t,{get:e[t],enumerable:!0})};var d=w(()=>{});var v,h=w(()=>{v={NODE_ENV:"production",NODE_PATH:[],STORYBOOK:"true",PUBLIC_URL:"."}});var p=w(()=>{});var be={};Ct(be,{Children:()=>wr,Component:()=>Ye,Fragment:()=>E,Profiler:()=>_r,PureComponent:()=>$r,StrictMode:()=>Ir,Suspense:()=>Ge,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>Sr,act:()=>Er,cloneElement:()=>Ar,createContext:()=>Cr,createElement:()=>Pr,createFactory:()=>Tr,createRef:()=>kr,default:()=>z,forwardRef:()=>Mr,isValidElement:()=>Rr,lazy:()=>We,memo:()=>Br,startTransition:()=>Nr,unstable_act:()=>Or,useCallback:()=>O,useContext:()=>Lr,useDebugValue:()=>Hr,useDeferredValue:()=>Dr,useEffect:()=>B,useId:()=>Fr,useImperativeHandle:()=>Ur,useInsertionEffect:()=>Vr,useLayoutEffect:()=>jr,useMemo:()=>Z,useReducer:()=>zr,useRef:()=>Yr,useState:()=>M,useSyncExternalStore:()=>Gr,useTransition:()=>Wr,version:()=>Zr});var z,wr,Ye,E,_r,$r,Ir,Ge,Sr,Er,Ar,Cr,Pr,Tr,kr,Mr,Rr,We,Br,Nr,Or,O,Lr,Hr,Dr,B,Fr,Ur,Vr,jr,Z,zr,Yr,M,Gr,Wr,Zr,ne=w(()=>{d();h();p();z=__REACT__,{Children:wr,Component:Ye,Fragment:E,Profiler:_r,PureComponent:$r,StrictMode:Ir,Suspense:Ge,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Sr,act:Er,cloneElement:Ar,createContext:Cr,createElement:Pr,createFactory:Tr,createRef:kr,forwardRef:Mr,isValidElement:Rr,lazy:We,memo:Br,startTransition:Nr,unstable_act:Or,useCallback:O,useContext:Lr,useDebugValue:Hr,useDeferredValue:Dr,useEffect:B,useId:Fr,useImperativeHandle:Ur,useInsertionEffect:Vr,useLayoutEffect:jr,useMemo:Z,useReducer:zr,useRef:Yr,useState:M,useSyncExternalStore:Gr,useTransition:Wr,version:Zr}=__REACT__});var tn,on,rn,nn,sn,an,ln,cn,dn,hn,pn,un,R,fn,mn,gn,vn,yn,m,bn,xn,wn,_n,$n,In,Sn,En,xe=w(()=>{d();h();p();tn=__STORYBOOK_THEMING__,{CacheProvider:on,ClassNames:rn,Global:nn,ThemeProvider:sn,background:an,color:ln,convert:cn,create:dn,createCache:hn,createGlobal:pn,createReset:un,css:R,darken:fn,ensure:mn,getPreferredColorScheme:gn,ignoreSsrWarning:vn,isPropValid:yn,jsx:m,keyframes:bn,lighten:xn,styled:wn,themes:_n,tokens:$n,typography:In,useTheme:Sn,withTheme:En}=__STORYBOOK_THEMING__});var kn,Mn,Rn,Bn,Nn,Pt,On,Ln,Hn,Dn,Fn,Un,Vn,jn,zn,Yn,Gn,Wn,Zn,Tt,qn,Kn,Xn,Jn,Qn,es,ts,os,we,rs,is,se,ns,ss,as,ls,cs,ds,L,hs,ps,us,fs,ms,gs,vs,kt,ys,bs,xs,ws,_s,$s,Is,Ss,Es,As,Cs,Ps,Ts,ks,Ms,Rs,Mt,Bs,Ns,Os,Ls,Hs,Ds,Fs,Us,Vs,js,zs,Ys,Gs,Ws,Zs,qs,Ks,Xs,Js,Qs,ea,ta,oa,_e=w(()=>{d();h();p();kn=__STORYBOOK_COMPONENTS__,{A:Mn,AbstractToolbar:Rn,ActionBar:Bn,ActionList:Nn,AddonPanel:Pt,Badge:On,Bar:Ln,Blockquote:Hn,Button:Dn,Card:Fn,ClipboardCode:Un,Code:Vn,Collapsible:jn,DL:zn,Div:Yn,DocumentWrapper:Gn,EmptyTabContent:Wn,ErrorFormatter:Zn,FlexBar:Tt,Form:qn,H1:Kn,H2:Xn,H3:Jn,H4:Qn,H5:es,H6:ts,HR:os,IconButton:we,Img:rs,LI:is,Link:se,ListItem:ns,Loader:ss,Modal:as,ModalDecorator:ls,OL:cs,P:ds,Placeholder:L,Popover:hs,PopoverProvider:ps,Pre:us,ProgressSpinner:fs,ResetWrapper:ms,ScrollArea:gs,Select:vs,Separator:kt,Spaced:ys,Span:bs,StatelessTab:xs,StatelessTabList:ws,StatelessTabPanel:_s,StatelessTabsView:$s,StorybookIcon:Is,StorybookLogo:Ss,SyntaxHighlighter:Es,TT:As,TabBar:Cs,TabButton:Ps,TabList:Ts,TabPanel:ks,TabWrapper:Ms,Table:Rs,Tabs:Mt,TabsState:Bs,TabsView:Ns,ToggleButton:Os,Toolbar:Ls,Tooltip:Hs,TooltipLinkList:Ds,TooltipMessage:Fs,TooltipNote:Us,TooltipProvider:Vs,UL:js,WithTooltip:zs,WithTooltipPure:Ys,Zoom:Gs,codeCommon:Ws,components:Zs,convertToReactAriaPlacement:qs,createCopyToClipboardFunction:Ks,getStoryHref:Xs,interleaveSeparators:Js,nameSpaceClassNames:Qs,resetComponents:ea,useTabsState:ta,withReset:oa}=__STORYBOOK_COMPONENTS__});function Qr(o,e){let t=new URL(o);t.hostname=t.hostname.replace(/^www\./,"embed."),t.searchParams.delete("embed_origin"),t.searchParams.set("embed-host",e);for(let[r,i]of t.searchParams)t.searchParams.delete(r),t.searchParams.set(r.replace(/_/g,"-"),i);return t.href}var $e,qr,Kr,Xr,Ze,Jr,Rt,Ie=w(()=>{d();h();p();ne();xe();_e();$e=({config:o,defer:e=!1})=>{let[t,r]=M(e?void 0:o.url),[i,n]=M(!1);return B(()=>{if(!e)return;let s=requestAnimationFrame(()=>{r(o.url)});return()=>cancelAnimationFrame(s)},[e,o.url]),B(()=>{n(!1)},[t]),m("div",{css:qr},!i&&m(L,{css:Kr},"Loading..."),m("iframe",{css:Xr,src:t,allowFullScreen:o.allowFullscreen,onLoad:()=>n(!0)}))},qr=R`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`+e.id,n=Po.get(i);return n||(n=wo(o.absoluteBoundingBox,e.absoluteBoundingBox),Po.set(i,n)),[...n.map(s=>di({guide:s,reverseScale:t})),...n.map(s=>hi({guide:s,reverseScale:t,fontSize:r}))]},ko=T`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`});var Ro,yt,Bo,No,Oo,bt=w(()=>{d();h();p();D();Ro=({onClick:o=()=>{}})=>k`
...
`,qo=o=>{if(!o||!o.link||o.link===void 0||o.link==="undefined")return null;let{link:e,timestamp:t,fileName:r}=o;return $`<a
        ...
        "
          >
            ...
            >
              ...
              ${N(this,r,"f").map(x=>{var _;return x.id===((_=this.selectedNode)===null||_===void 0?void 0:_.id)?null:k`
                  <g>
  ...
  bottom: 0;
  left: 0;
`;dr=({config:o})=>{let[e,t]=M({state:"loading"}),r=async i=>{t({state:"loading"});try{let n=o.url.match(Ze);if(!n)throw new Error(o.url+" is not a valid Figma URL.");let[,,s]=n,c=new URL(o.url).searchParams.get("node-id"),a=Ai(o);if(!a)throw new Error("Personal Access Token is required.");let u={"X-FIGMA-TOKEN":a},l=new URL(`https://api.figma.com/v1/files/${s}`),f=new URL(`https://api.figma.com/v1/images/${s}`);if(f.searchParams.set("format","svg"),!c){let _=await fetch(l.href,{headers:u,signal:i}).then(S=>Ve(S)),I=hr(_.document);f.searchParams.set("ids",I.map(S=>S.id).join(","));let P=await fetch(f.href,{headers:u,signal:i}).then(S=>Ve(S));t({state:"fetched",value:{type:"file",props:{documentNode:_,renderedImages:P.images,link:o.url}}});return}l.pathname+="/nodes",l.searchParams.set("ids",c),f.searchParams.set("ids",c);let[g,x]=await Promise.all([fetch(l.href,{headers:u,signal:i}).then(_=>Ve(_)),fetch(f.href,{headers:u,signal:i}).then(_=>Ve(_))]);t({state:"fetched",value:{type:"frame",props:{nodes:g,renderedImage:Object.values(x.images)[0],link:o.url}}})}catch(n){if(n instanceof DOMException&&n.code===DOMException.ABORT_ERR)return;console.error(n),t({state:"failed",error:n instanceof Error?n.message:String(n)})}};switch(B(()=>{let i=!1,n=()=>{i=!0},s=new AbortController;return r(s.signal).then(n,n),()=>{i||s.abort()}},[o.url]),e.state){case"loading":return m(L,null,m(E,null,"Loading Figma file..."));case"failed":return m(L,null,m(E,null,"Failed to load Figma file"),m(E,null,e.error));case"fetched":return e.value.type==="file"?m(ar,{css:cr,...e.value.props}):m(sr,{css:cr,...e.value.props})}},Ci=dr});d();h();p();d();h();p();d();h();p();Ie();ne();d();h();p();var fa=__STORYBOOK_API__,{ActiveTabs:ma,Consumer:ga,ManagerContext:va,Provider:ya,RequestResponseError:ba,addons:Se,combineParameters:xa,controlOrMetaKey:wa,controlOrMetaSymbol:_a,eventMatchesShortcut:$a,eventToShortcut:Ia,experimental_MockUniversalStore:Sa,experimental_UniversalStore:Ea,experimental_getStatusStore:Aa,experimental_getTestProviderStore:Ca,experimental_requestResponse:Pa,experimental_useStatusStore:Ta,experimental_useTestProviderStore:ka,experimental_useUniversalStore:Ma,internal_checklistStore:Ra,internal_fullStatusStore:Ba,internal_fullTestProviderStore:Na,internal_universalChecklistStore:Oa,internal_universalStatusStore:La,internal_universalTestProviderStore:Ha,isMacLike:Da,isShortcutTaken:Fa,keyToSymbol:Ua,merge:Va,mockChannel:ja,optionOrAltSymbol:za,shortcutMatchesShortcut:Ya,shortcutToAriaKeyshortcuts:Ga,shortcutToHumanString:Wa,types:qe,useAddonState:Za,useArgTypes:qa,useArgs:Ka,useChannel:Xa,useGlobalTypes:Ja,useGlobals:Qa,useParameter:Ke,useSharedState:el,useStoryPrepared:tl,useStorybookApi:ol,useStorybookState:Bt}=__STORYBOOK_API__;_e();xe();d();h();p();var al=__STORYBOOK_ICONS__,{AccessibilityAltIcon:ll,AccessibilityIcon:cl,AccessibilityIgnoredIcon:dl,AddIcon:hl,AdminIcon:pl,AlertAltIcon:ul,AlertIcon:fl,AlignLeftIcon:ml,AlignRightIcon:gl,AppleIcon:vl,ArrowBottomLeftIcon:yl,ArrowBottomRightIcon:bl,ArrowDownIcon:xl,ArrowLeftIcon:wl,ArrowRightIcon:_l,ArrowSolidDownIcon:$l,ArrowSolidLeftIcon:Il,ArrowSolidRightIcon:Sl,ArrowSolidUpIcon:El,ArrowTopLeftIcon:Al,ArrowTopRightIcon:Cl,ArrowUpIcon:Pl,AzureDevOpsIcon:Tl,BackIcon:kl,BasketIcon:Ml,BatchAcceptIcon:Rl,BatchDenyIcon:Bl,BeakerIcon:Nl,BellIcon:Ol,BitbucketIcon:Ll,BoldIcon:Hl,BookIcon:Dl,BookmarkHollowIcon:Fl,BookmarkIcon:Ul,BottomBarIcon:Vl,BottomBarToggleIcon:jl,BoxIcon:zl,BranchIcon:Yl,BrowserIcon:Gl,BugIcon:Wl,ButtonIcon:Zl,CPUIcon:ql,CalendarIcon:Kl,CameraIcon:Xl,CameraStabilizeIcon:Jl,CategoryIcon:Ql,CertificateIcon:ec,ChangedIcon:tc,ChatIcon:oc,CheckIcon:rc,ChevronDownIcon:ic,ChevronLeftIcon:nc,ChevronRightIcon:sc,ChevronSmallDownIcon:ac,ChevronSmallLeftIcon:lc,ChevronSmallRightIcon:cc,ChevronSmallUpIcon:dc,ChevronUpIcon:hc,ChromaticIcon:pc,ChromeIcon:uc,CircleHollowIcon:fc,CircleIcon:mc,ClearIcon:gc,CloseAltIcon:vc,CloseIcon:yc,CloudHollowIcon:bc,CloudIcon:xc,CogIcon:wc,CollapseIcon:_c,CommandIcon:$c,CommentAddIcon:Ic,CommentIcon:Sc,CommentsIcon:Ec,CommitIcon:Ac,CompassIcon:Cc,ComponentDrivenIcon:Pc,ComponentIcon:Tc,ContrastIcon:kc,ContrastIgnoredIcon:Mc,ControlsIcon:Rc,CopyIcon:Bc,CreditIcon:Nc,CrossIcon:Oc,DashboardIcon:Lc,DatabaseIcon:Hc,DeleteIcon:Dc,DiamondIcon:Fc,DirectionIcon:Uc,DiscordIcon:Vc,DocChartIcon:jc,DocListIcon:zc,DocumentIcon:Yc,DownloadIcon:Gc,DragIcon:Wc,EditIcon:Zc,EditorIcon:qc,EllipsisIcon:Kc,EmailIcon:Xc,ExpandAltIcon:Jc,ExpandIcon:Qc,EyeCloseIcon:ed,EyeIcon:td,FaceHappyIcon:od,FaceNeutralIcon:rd,FaceSadIcon:id,FacebookIcon:nd,FailedIcon:sd,FastForwardIcon:ad,FigmaIcon:ld,FilterIcon:cd,FlagIcon:dd,FolderIcon:hd,FormIcon:pd,GDriveIcon:ud,GiftIcon:fd,GithubIcon:md,GitlabIcon:gd,GlobeIcon:vd,GoogleIcon:yd,GraphBarIcon:bd,GraphLineIcon:xd,GraphqlIcon:wd,GridAltIcon:_d,GridIcon:$d,GrowIcon:Id,HeartHollowIcon:Sd,HeartIcon:Ed,HomeIcon:Ad,HourglassIcon:Cd,InfoIcon:Pd,ItalicIcon:Td,JumpToIcon:kd,KeyIcon:Md,LightningIcon:Rd,LightningOffIcon:Bd,LinkBrokenIcon:Nd,LinkIcon:Od,LinkedinIcon:Ld,LinuxIcon:Hd,ListOrderedIcon:Dd,ListUnorderedIcon:Fd,LocationIcon:Ud,LockIcon:Vd,MarkdownIcon:jd,MarkupIcon:zd,MediumIcon:Yd,MemoryIcon:Gd,MenuIcon:Wd,MergeIcon:Zd,MirrorIcon:qd,MobileIcon:Kd,MoonIcon:Xd,NutIcon:Jd,OutboxIcon:Qd,OutlineIcon:eh,PaintBrushAltIcon:th,PaintBrushIcon:oh,PaperClipIcon:rh,ParagraphIcon:ih,PassedIcon:nh,PhoneIcon:sh,PhotoDragIcon:ah,PhotoIcon:lh,PhotoStabilizeIcon:ch,PinAltIcon:dh,PinIcon:hh,PlayAllHollowIcon:ph,PlayBackIcon:uh,PlayHollowIcon:fh,PlayIcon:mh,PlayNextIcon:gh,PlusIcon:vh,PointerDefaultIcon:yh,PointerHandIcon:bh,PowerIcon:xh,PrintIcon:wh,ProceedIcon:_h,ProfileIcon:$h,PullRequestIcon:Ih,QuestionIcon:Sh,RSSIcon:Eh,RedirectIcon:Ah,ReduxIcon:Ch,RefreshIcon:Ph,ReplyIcon:Th,RepoIcon:kh,RequestChangeIcon:Mh,RewindIcon:Rh,RulerIcon:Bh,SaveIcon:Nh,SearchIcon:Oh,ShareAltIcon:Lh,ShareIcon:Hh,ShieldIcon:Dh,SideBySideIcon:Fh,SidebarAltIcon:Uh,SidebarAltToggleIcon:Vh,SidebarIcon:jh,SidebarToggleIcon:zh,SortDownIcon:Yh,SortUpIcon:Gh,SpeakerIcon:Wh,StackedIcon:Zh,StarHollowIcon:qh,StarIcon:Kh,StatusFailIcon:Xh,StatusIcon:Jh,StatusPassIcon:Qh,StatusWarnIcon:ep,StickerIcon:tp,StopAltHollowIcon:op,StopAltIcon:rp,StopIcon:ip,StorybookIcon:np,StructureIcon:sp,SubtractIcon:ap,SunIcon:lp,SupportIcon:cp,SweepIcon:dp,SwitchAltIcon:hp,SyncIcon:pp,TabletIcon:up,ThumbsUpIcon:fp,TimeIcon:mp,TimerIcon:gp,TransferIcon:vp,TrashIcon:yp,TwitterIcon:bp,TypeIcon:xp,UbuntuIcon:wp,UndoIcon:_p,UnfoldIcon:$p,UnlockIcon:Ip,UnpinIcon:Sp,UploadIcon:Ep,UserAddIcon:Ap,UserAltIcon:Cp,UserIcon:Pp,UsersIcon:Tp,VSCodeIcon:kp,VerifiedIcon:Mp,VideoIcon:Rp,WandIcon:Bp,WatchIcon:Np,WindowsIcon:Op,WrenchIcon:Lp,XIcon:Hp,YoutubeIcon:Dp,ZoomIcon:Nt,ZoomOutIcon:Ot,ZoomResetIcon:Lt,iconList:Fp}=__STORYBOOK_ICONS__;var vr="STORYBOOK_ADDON_DESIGNS",fr=vr+"/panel",je="design",mr=class extends Ye{state={hasError:!1};static getDerivedStateFromError(o){return{hasError:!0,error:o}}componentDidCatch(o,e){console.group("An error occurred during rendering Addon panel of storybook-addon-designs"),console.log("--- Error ---"),console.error(o),console.log("--- React Component Stack ---"),console.error(e.componentStack),console.groupEnd()}render(){return this.state.hasError?m(L,null,m(E,null,"Failed to render addon UI"),m(E,null,m("p",null,"Sorry, this addon has crashed due to the below error has thrown during rendering the addon UI."),m("pre",null,String(this.state.error)),m("p",null,"See console log for more details. To clear the error state, please reload the page."," ",m(se,{href:"https://github.com/storybookjs/addon-designs/issues/new?assignees=&labels=category%3A+bug&template=bug_report.yml",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"Bug report")))):this.props.children}},Pi=(o,e)=>{let[t,r]=M([0,0]),[i,n]=M(!1),s=O(g=>{g.button===0&&(r([g.screenX,g.screenY]),n(!0))},[n,r]),c=O(g=>{let x=g.touches[0];r([x.screenX,x.screenY]),n(!0)},[n,r]),a=O(g=>{i&&r(x=>(o([g[0]-x[0],g[1]-x[1]]),g))},[r,i,...e]),u=O(g=>{let{screenX:x,screenY:_}=g;a([x,_])},[a]),l=O(g=>{let{screenX:x,screenY:_}=g.touches[0];a([x,_])},[r,i,...e]),f=O(()=>{r([0,0]),n(!1)},[n,r]);return{onMouseDown:s,onMouseMove:u,onMouseUp:f,onMouseLeave:f,onTouchStart:c,onTouchMove:l,onTouchCancel:f,onTouchEnd:f}},Ti=({children:o,className:e,style:t,defaultValue:r,value:i,onChange:n})=>{let[s,c]=M([0,0]);B(()=>{c(r||i||[0,0])},[r]);let a=Pi(l=>{n&&n(l),c(f=>[f[0]+l[0],f[1]+l[1]])},[c,n]),u=Z(()=>{let l=i||s;return{transform:`translate(${l[0]}px, ${l[1]}px)`}},[i,s]);return m("div",{css:ki,className:e,style:t,...a},m("div",{css:Mi,style:u},o))},ki=R`
  position: relative;
  overflow: hidden;
